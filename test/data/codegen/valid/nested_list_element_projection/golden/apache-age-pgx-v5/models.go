...
func decodeGrid(raw []byte) (Grid, error) {
	...
	out.Id = value0
	value1, err := agtypeProperty(props, "labels", agtypeListOfNullableString)
	if err != nil {
		return Grid{}, fmt.Errorf("decode Grid.Labels: %w", err)
	}
	out.Labels = value1
	value2, err := agtypeNullableProperty(props, "ranks", agtypeListOfInt16)
	if err != nil {
		return Grid{}, fmt.Errorf("decode Grid.Ranks: %w", err)
	}
	out.Ranks = value2
	value3, err := agtypeNullableProperty(props, "tags", agtypeListOfNullableString)
	if err != nil {
		return Grid{}, fmt.Errorf("decode Grid.Tags: %w", err)
	}
	out.Tags = value3
	return out, nil
}
...
// agtypeListOfNullableListOfNullableString decodes an agtype list of *[]*string elements.
func agtypeListOfNullableListOfNullableString(raw []byte) ([]*[]*string, error) {
	return agtypeList(raw, agtypeNullableElem(agtypeListOfNullableString))
}

// agtypeListOfNullableListOfInt16 decodes an agtype list of *[]int16 elements.
func agtypeListOfNullableListOfInt16(raw []byte) ([]*[]int16, error) {
	return agtypeList(raw, agtypeNullableElem(agtypeListOfInt16))
}

// agtypeListOfListOfNullableString decodes an agtype list of []*string elements.
func agtypeListOfListOfNullableString(raw []byte) ([][]*string, error) {
	return agtypeList(raw, agtypeListOfNullableString)
}
