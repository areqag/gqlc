...
// agtypeListOfListOfListOfInt64 decodes an agtype list of [][]int64 elements.
func agtypeListOfListOfListOfInt64(raw []byte) ([][][]int64, error) {
	return agtypeList(raw, agtypeListOfListOfInt64)
}
