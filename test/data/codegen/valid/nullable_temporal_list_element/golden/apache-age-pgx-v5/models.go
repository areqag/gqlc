...
func decodeSlot(raw []byte) (Slot, error) {
	...
	var out Slot
	value0, err := agtypeProperty(props, "days", agtypeListOfNullableDate)
	if err != nil {
	...
	out.Id = value1
	value2, err := agtypeNullableProperty(props, "maybe", agtypeListOfNullableDate)
	if err != nil {
		return Slot{}, fmt.Errorf("decode Slot.Maybe: %w", err)
	}
	out.Maybe = value2
	value3, err := agtypeProperty(props, "spans", agtypeListOfDuration)
	if err != nil {
...
// agtypeListOfNullableDate decodes an agtype list of *Date elements.
func agtypeListOfNullableDate(raw []byte) ([]*Date, error) {
	return agtypeList(raw, agtypeNullableElem(agtypeDate))
}
