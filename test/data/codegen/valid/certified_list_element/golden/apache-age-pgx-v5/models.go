...
func decodePerson(raw []byte) (Person, error) {
	...
	var out Person
	value0, err := agtypeProperty(props, "age", agtypeInt64)
	if err != nil {
	...
	out.Id = value1
	value2, err := agtypeProperty(props, "rank", agtypeIntAs[int32])
	if err != nil {
		return Person{}, fmt.Errorf("decode Person.Rank: %w", err)
	}
	out.Rank = value2
	value3, err := agtypeNullableProperty(props, "score", agtypeInt64)
	if err != nil {
		return Person{}, fmt.Errorf("decode Person.Score: %w", err)
	}
	out.Score = value3
	return out, nil
}
...
// agtypeListOfNullableInt64 decodes an agtype list of *int64 elements.
func agtypeListOfNullableInt64(raw []byte) ([]*int64, error) {
	return agtypeList(raw, agtypeNullableElem(agtypeInt64))
}
...
// agtypeListOfInt64 decodes an agtype list of int64 elements.
func agtypeListOfInt64(raw []byte) ([]int64, error) {
	return agtypeList(raw, agtypeInt64)
}

// agtypeListOfListOfInt64 decodes an agtype list of []int64 elements.
func agtypeListOfListOfInt64(raw []byte) ([][]int64, error) {
	return agtypeList(raw, agtypeListOfInt64)
}
