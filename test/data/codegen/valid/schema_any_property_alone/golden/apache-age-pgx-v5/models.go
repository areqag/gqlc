...
func decodeBlob(raw []byte) (Blob, error) {
	...
	var out Blob
	value0, err := agtypeNullableProperty(props, "payload", agtypeValue)
	if err != nil {
		return Blob{}, fmt.Errorf("decode Blob.Payload: %w", err)
	}
	out.Payload = value0
	value1, err := agtypeNullableProperty(props, "tag", agtypeValue)
	if err != nil {
		return Blob{}, fmt.Errorf("decode Blob.Tag: %w", err)
	}
	out.Tag = value1
	return out, nil
}
