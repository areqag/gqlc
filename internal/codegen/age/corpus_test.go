...
var corpusTests = []string{
	...
	"TestDecodeVertexReadsARecordProperty",
	"TestDecodeVertexReadsAbsenceInsideAndAroundARecord",
	"TestDecodeVertexRefusesARecordMissingANotNullField",
...
var corpusTables = map[string]corpusrun.Table{
	...
	"TestSlotElementsStayBareUnderNotNull":                    {Rows: 3},
