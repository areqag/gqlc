...
// connection is handed out. The statement is a gate that a
// plausible-looking edit can silently reopen, so the test suite carries
// its own copy of the text and compares.
