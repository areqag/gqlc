...
// connectionSurface, which is declared in
...
// handle and differ by construction. Do not delete this test as
// redundant with that one, and do not un-exclude db.go there instead —
// the rest of db.go differs on purpose.
