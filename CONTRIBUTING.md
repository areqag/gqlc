...
specifically, until the config is repaired. Outside any repo, and inside one
that ships no `.githooks/` at all, it stays silent — both are pinned rows. Those four were picked by measuring
