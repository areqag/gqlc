...
test-codegen-live-neo4j:
    cd test/data/codegen && go test -v -tags codegen_live -run 'TestLiveSmoke|TestEveryBatteryIsTheDeclaredSize|TestEveryBatteryIsNamedInScenarioTables|TestTxMethodSet|TestNeo4jRefusesANestedListStoredProperty|TestNeo4jRefusesAMapValuedStoredProperty|TestNeo4jRefusesAHeterogeneousArrayStoredProperty|TestNeo4jRefusesAUint64ParameterAboveMaxInt64|TestNeo4jStoresAndRoundTripsAUUID|TestNeo4jNeverHandsBackANullValuedProperty|TestAGERefusesAUint64ParameterAboveMaxInt64|TestAGERefusesAUnionParameterOutsideTheDeclaredMemberSet|TestEveryAgtypeCaptureIsWitnessedOrDeclaredSynthetic|TestNeo4jMinOverAnEmptyGroupIsNull' -skip 'TestLiveSmoke/apache-age' ./...
